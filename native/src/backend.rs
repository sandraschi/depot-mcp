...
const BACKEND_NAME: &str = "depot-mcp-backend.exe";
const BACKEND_PORT: u16 = 10727;
const BACKEND_TAG: &str = "depot-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "DEPOT_MCP_PORT";
const ENV_HOST: &str = "DEPOT_MCP_HOST";
const ENV_TAURI: &str = "DEPOT_MCP_TAURI";
